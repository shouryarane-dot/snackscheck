...
const BADGES=[
  ...
  {name:"Snack Ambassador",icon:"🌍",min:75 },
  {name:"Snack Expert",    icon:"🏆",min:200},
  {name:"Snack Legend",    icon:"👑",min:500},
];
